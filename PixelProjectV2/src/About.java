...
public class About extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BG.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 310, 120));

        jLabel4.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("It could be also challenging depending on the difficulty selected.");
        BG.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, -1, -1));

        jLabel3.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("PixelPuzzler is a game that everyone can enjoy.");
        BG.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, -1, -1));
